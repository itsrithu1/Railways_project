  ...
  return (
    ...
    <>
      ...
      <form onSubmit={handleSubmit} >
          ...
          <div class="add_train" style={{ border: '1px solid #ccc', padding: '20px' }}>
            ...
            <div class="input" style={{ margin: '20px' }}>
              ...
              <label style={{ width:'150px' }}>Destination:</label>
            ...
            <div class="input" style={{ margin: '20px' }}>
              ...
              <label style={{ width:'150px' }}>Source time:</label>
            ...
            <div class="input" style={{ margin: '20px' }}>
              ...
              <label style={{ width:'150px' }}> No of Seats:</label>
            ...
            <button type="button" onClick={handleBack} style={{borderRadius: '5px', marginLeft:'100px'}}>Back</button>
